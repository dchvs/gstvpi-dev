...
static const gchar *test_pipes[] = {
  "videotestsrc ! vpiupload ! vpiboxfilter ! vpidownload ! fakesink",
  NULL,
};
...
static Suite *
gst_vpi_box_filter_suite (void)
{
  Suite *suite = suite_create ("vpiboxfilter");
...
GST_CHECK_MAIN (gst_vpi_box_filter);
